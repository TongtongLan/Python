...
class TestSet:
    ...
    def binary(self, dir_pic):
        ...
        for f in os.listdir(dir_pic):
            if f.endswith('.png'):
                ...
                img.save("/home/tongtong/pic_codec/TestImage/" + f)
        ...
        for i in range(0, len(X_value), 2):
            try:
                ...
                img.crop((X_value[i], Y_value[0], X_value[i + 1], Y_value[(len(Y_value) - 1)] + 1)).save(
                    "/home/tongtong/pic_codec/TestNum/%d%d.jpg" % (i / 2, img_len))
            except:
                Image.open(ur"/home/tongtong/pic_codec/TestNum/%d.jpg" % (i / 2))
    ...
    def train_svm_model(self, svm_root, model_path):
        """
        训练并生成model文件
        :return:
        """
...
TestSet().binary('/home/tongtong/codectest/test/')